    ...
    <div className="w-full">
      <div className="mb-8 flex items-start justify-between gap-4">
        <div>
          ...
          <h1 className="font-poppins text-3xl font-bold text-zinc-900">Daily and monthly metrics</h1>
          <p className="mt-1 text-zinc-500">Save revenue, census, or operations separately, then use history when a category needs correction.</p>
        </div>
